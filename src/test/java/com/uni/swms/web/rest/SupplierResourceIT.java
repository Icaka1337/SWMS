...
import static com.uni.swms.domain.SupplierAsserts.*;
...
class SupplierResourceIT {
    ...
    private static final Double DEFAULT_RELIABILITY_SCORE = 1D;
    private static final Double UPDATED_RELIABILITY_SCORE = 2D;
    private static final Double SMALLER_RELIABILITY_SCORE = 1D - 1D;
    ...
    public static Supplier createUpdatedEntity() {
        return new Supplier()
            ...
            .reliabilityScore(UPDATED_RELIABILITY_SCORE)
            .email(UPDATED_EMAIL)
            .phone(UPDATED_PHONE);
    }
    ...
    void getAllSuppliers() throws Exception {
        ...
        restSupplierMockMvc
            ...
            .andExpect(jsonPath("$.[*].reliabilityScore").value(hasItem(DEFAULT_RELIABILITY_SCORE)))
    ...
    void getSupplier() throws Exception {
        ...
        restSupplierMockMvc
            ...
            .andExpect(jsonPath("$.reliabilityScore").value(DEFAULT_RELIABILITY_SCORE))
    ...
    @Test
    @Transactional
    void getAllSuppliersByContactInfoIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedSupplier = supplierRepository.saveAndFlush(supplier);

        // Get all the supplierList where contactInfo equals to
        defaultSupplierFiltering("contactInfo.equals=" + DEFAULT_CONTACT_INFO, "contactInfo.equals=" + UPDATED_CONTACT_INFO);
    }

    @Test
    @Transactional
    void getAllSuppliersByContactInfoIsInShouldWork() throws Exception {
        // Initialize the database
        insertedSupplier = supplierRepository.saveAndFlush(supplier);

        // Get all the supplierList where contactInfo in
    ...
    @Test
    @Transactional
    void getAllSuppliersByContactInfoIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedSupplier = supplierRepository.saveAndFlush(supplier);

        // Get all the supplierList where contactInfo is not null
        defaultSupplierFiltering("contactInfo.specified=true", "contactInfo.specified=false");
    }

    @Test
    @Transactional
    void getAllSuppliersByContactInfoContainsSomething() throws Exception {
        // Initialize the database
        insertedSupplier = supplierRepository.saveAndFlush(supplier);

        // Get all the supplierList where contactInfo contains
        defaultSupplierFiltering("contactInfo.contains=" + DEFAULT_CONTACT_INFO, "contactInfo.contains=" + UPDATED_CONTACT_INFO);
    }

    @Test
    @Transactional
    void getAllSuppliersByContactInfoNotContainsSomething() throws Exception {
        // Initialize the database
        insertedSupplier = supplierRepository.saveAndFlush(supplier);

        // Get all the supplierList where contactInfo does not contain
        defaultSupplierFiltering(
    ...
    @Test
    @Transactional
    void getAllSuppliersByReliabilityScoreIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedSupplier = supplierRepository.saveAndFlush(supplier);

        // Get all the supplierList where reliabilityScore equals to
        defaultSupplierFiltering(
            "reliabilityScore.equals=" + DEFAULT_RELIABILITY_SCORE,
            "reliabilityScore.equals=" + UPDATED_RELIABILITY_SCORE
        );
    }

    @Test
    @Transactional
    void getAllSuppliersByReliabilityScoreIsInShouldWork() throws Exception {
        // Initialize the database
        insertedSupplier = supplierRepository.saveAndFlush(supplier);

        // Get all the supplierList where reliabilityScore in
        defaultSupplierFiltering(
            "reliabilityScore.in=" + DEFAULT_RELIABILITY_SCORE + "," + UPDATED_RELIABILITY_SCORE,
            "reliabilityScore.in=" + UPDATED_RELIABILITY_SCORE
        );
    }

    @Test
    @Transactional
    void getAllSuppliersByReliabilityScoreIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedSupplier = supplierRepository.saveAndFlush(supplier);

        // Get all the supplierList where reliabilityScore is not null
        defaultSupplierFiltering("reliabilityScore.specified=true", "reliabilityScore.specified=false");
    }

    @Test
    @Transactional
    void getAllSuppliersByReliabilityScoreIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        insertedSupplier = supplierRepository.saveAndFlush(supplier);

        // Get all the supplierList where reliabilityScore is greater than or equal to
        defaultSupplierFiltering(
            "reliabilityScore.greaterThanOrEqual=" + DEFAULT_RELIABILITY_SCORE,
            "reliabilityScore.greaterThanOrEqual=" + UPDATED_RELIABILITY_SCORE
        );
    }

    @Test
    @Transactional
    void getAllSuppliersByReliabilityScoreIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        insertedSupplier = supplierRepository.saveAndFlush(supplier);

        // Get all the supplierList where reliabilityScore is less than or equal to
        defaultSupplierFiltering(
            "reliabilityScore.lessThanOrEqual=" + DEFAULT_RELIABILITY_SCORE,
            "reliabilityScore.lessThanOrEqual=" + SMALLER_RELIABILITY_SCORE
        );
    }

    @Test
    @Transactional
    void getAllSuppliersByReliabilityScoreIsLessThanSomething() throws Exception {
        // Initialize the database
        insertedSupplier = supplierRepository.saveAndFlush(supplier);

        // Get all the supplierList where reliabilityScore is less than
        defaultSupplierFiltering(
            "reliabilityScore.lessThan=" + UPDATED_RELIABILITY_SCORE,
            "reliabilityScore.lessThan=" + DEFAULT_RELIABILITY_SCORE
        );
    }

    @Test
    @Transactional
    void getAllSuppliersByReliabilityScoreIsGreaterThanSomething() throws Exception {
        // Initialize the database
        insertedSupplier = supplierRepository.saveAndFlush(supplier);

        // Get all the supplierList where reliabilityScore is greater than
        defaultSupplierFiltering(
            "reliabilityScore.greaterThan=" + SMALLER_RELIABILITY_SCORE,
            "reliabilityScore.greaterThan=" + DEFAULT_RELIABILITY_SCORE
        );
    }
    ...
    void partialUpdateSupplierWithPatch() throws Exception {
        ...
        partialUpdatedSupplier.contactInfo(UPDATED_CONTACT_INFO).email(UPDATED_EMAIL);
