...
import static com.uni.swms.domain.CustomerAsserts.*;
...
import com.uni.swms.repository.CustomerRepository;
import com.uni.swms.service.dto.CustomerDTO;
import com.uni.swms.service.mapper.CustomerMapper;
...
class CustomerResourceIT {
    ...
    public static Customer createEntity() {
        return new Customer().name(DEFAULT_NAME).email(DEFAULT_EMAIL).phone(DEFAULT_PHONE);
    }
    ...
    public static Customer createUpdatedEntity() {
        return new Customer().name(UPDATED_NAME).email(UPDATED_EMAIL).phone(UPDATED_PHONE);
    }
    ...
    void putExistingCustomer() throws Exception {
        ...
        updatedCustomer.name(UPDATED_NAME).email(UPDATED_EMAIL).phone(UPDATED_PHONE);
    ...
    void partialUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.name(UPDATED_NAME).email(UPDATED_EMAIL).phone(UPDATED_PHONE);
