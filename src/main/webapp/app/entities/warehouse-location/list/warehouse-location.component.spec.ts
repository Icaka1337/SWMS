...
import { sampleWithRequiredData } from '../warehouse-location.test-samples';
...
describe('WarehouseLocation Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.warehouseLocations()[0]).toEqual(expect.objectContaining({ id: 22623 }));
  });

  describe('trackId', () => {
    it('should forward to warehouseLocationService', () => {
      const entity = { id: 22623 };
      jest.spyOn(service, 'getWarehouseLocationIdentifier');
      const id = comp.trackId(entity);
      expect(service.getWarehouseLocationIdentifier).toHaveBeenCalledWith(entity);
